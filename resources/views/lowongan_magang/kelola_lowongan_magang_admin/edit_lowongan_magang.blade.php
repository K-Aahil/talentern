                        ...
                        <form class="default-form" id="wizard-validation-form" onSubmit="return false" method="POST"
                            ...
                            <div id="personal-info-validation" class="content">
                                ...
                                <div class="row g-3">
                                        ...
                                        <div class="border py-2 px-3 rounded-3">
                                            ...
                                            <div class="form-group" style="margin-top: 5px;">
                                                ...
                                                <select name="fakultas" id="fakultas" class="select2 form-select"
                                                    ...
                                                    @foreach ($fakultas as $f)
                                                        <option @if ($f->namafakultas == $lowongan->id_fakultas) selected @endif
                                                            value="{{ $f->namafakultas }}">{{ $f->namafakultas }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group" style="margin-top: 5px;">
                                                ...
                                                <select name="prodi" id="prodi" class="select2 form-select"
                                                    ...
                                                    @foreach ($prodi as $p)
                                                        <option @if ($p->namaprodi == $lowongan->id_prodi) selected @endif
                                                            value="{{ $p->namaprodi }}">{{ $p->namaprodi }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 col-sm-6">
                                        <label class="form-label" for="durasimagang">Durasi Magang<span
                                                class="text-danger">*</span></label>
                                            <select name="durasimagang" id="durasimagang" class="select2 form-select"
                                                data-placeholder="Pilih Durasi Magang">
                                                <option value="" disabled selected>Pilih Durasi Magang</option>
