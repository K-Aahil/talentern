                                        ...
                                        <div class="form-group" style="margin-top: 5px;">
                                            ...
                                            <select name="fakultas" id="fakultas" class="select2 form-select"
                                                ...
                                                @foreach ($fakultas as $f)
                                                    <option value="{{ $f->namafakultas }}" data-select2-id="{{ $f->namafakultas }}">{{ $f->namafakultas }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group" style="margin-top: 5px;">
                                            ...
                                            <select name="prodi" id="prodi" class="select2 form-select"
                                                ...
                                                @foreach ($prodi as $p)
                                                    <option value="{{ $p->namaprodi }}" data-select2-id="{{ $f->namaprodi }}">{{ $p->namaprodi }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
